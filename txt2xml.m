...
clear;  
%??????????  
imgpath='/Users/zsx/Desktop/xg/';
txtpath='/Users/zsx/Desktop/result.txt';
xmlpath_new='/Users/zsx/Desktop/Annotations/';
foldername='VOC2007';  
      ...
      pause(0.1);  
        ...
        if strcmp(str{1},lastname)%????????????object  
           ...
           if exist('Createnode','var')  
              tempname=lastname;  
              tempname=strrep(tempname,'.jpg','.xml');                                                                          %?????JPEG,?????jpg??JPEG   
